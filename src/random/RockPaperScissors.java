...
public class RockPaperScissors extends JPanel implements ActionListener{
    ...
    public void run(){
		...
		try {
			...
			rockImage = new ImageIcon(getClass().getResource("rock1.jpg"));
			paperImage = new ImageIcon(getClass().getResource("paper1.jpeg"));
			scissorsImage = new ImageIcon(getClass().getResource("scissors1.jpg"));
